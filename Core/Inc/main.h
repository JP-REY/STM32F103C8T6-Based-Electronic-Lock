...
#define MKB_IN1_PIN_Pin GPIO_PIN_0
#define MKB_IN1_PIN_GPIO_Port GPIOA
#define MKB_IN2_PIN_Pin GPIO_PIN_1
#define MKB_IN2_PIN_GPIO_Port GPIOA
#define MKB_IN3_PIN_Pin GPIO_PIN_2
#define MKB_IN3_PIN_GPIO_Port GPIOA
#define MKB_IN4_PIN_Pin GPIO_PIN_3
#define MKB_IN4_PIN_GPIO_Port GPIOA
#define MKB_OUT1_PIN_Pin GPIO_PIN_4
#define MKB_OUT1_PIN_GPIO_Port GPIOA
#define MKB_OUT2_PIN_Pin GPIO_PIN_5
#define MKB_OUT2_PIN_GPIO_Port GPIOA
#define MKB_OUT3_PIN_Pin GPIO_PIN_6
#define MKB_OUT3_PIN_GPIO_Port GPIOA
#define MKB_OUT4_PIN_Pin GPIO_PIN_7
#define MKB_OUT4_PIN_GPIO_Port GPIOA
#define BUZZER1_OUT_PIN_Pin GPIO_PIN_2
#define BUZZER1_OUT_PIN_GPIO_Port GPIOB
