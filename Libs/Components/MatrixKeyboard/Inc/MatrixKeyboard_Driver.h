...
typedef struct
{
    ...
    /* << Most recent raw electrical level sampled from the hardware.     >> */ MK_KeyLevel_t _key_raw_level;
    /* << Candidate level currently being validated.                      >> */ MK_KeyLevel_t _candidate_level;
...
typedef struct
{
    ...
    /* << Private data. Do not read or modify!                  >> */
    /* << Current stable logical level of the key.              >> */ MK_KeyLevel_t        _current_stable_level;
    /* << Previously validated stable logical level.            >> */ MK_KeyLevel_t        _previous_stable_level;
    /* << Current state of the key state machine.               >> */ MK_KeyState_t        _state;
    /* << Debounce processing context.                          >> */ MK_DebounceContext_t _debounce_ctx;
    /* << Most recent logical event generated for this key.     >> */ MK_KeyStateEvent_t   _output_event;
    /* << Most recent high-level action generated for this key. >> */ MK_KeyAction_t       _output_action;
...
{
    /* << Private data. Do not read or modify!                    >> */
    /* << Total number of matrix rows.                            >> */ MK_RowsQty_t        _rows_number;
    /* << Total number of matrix cols.                            >> */ MK_ColsQty_t        _cols_number;
    /* << Pointer to the application key map.                     >> */ const MK_KeyCode_t* _key_map;
    /* << Electrical active level corresponding to a pressed key. >> */ MK_KeyActiveLevel_t _row_active_level;
...
{
    /* << Private data. Do not read or modify!                                     >> */
    /* << Pointer to the driver configuration.                                     >> */ const MK_Config_t* _config;
    /* << Pointer to the runtime key table. One entry per physical key.            >> */ MK_Key_t*          _keys;
    /* << Hardware scan interface implementation associated with this instance.    >> */ MK_ScanInterface_t _scan_interface;
...
typedef struct
{
    /* << Logical identifier of the key associated with the generated action. >> */ MK_KeyCode_t   Key;
    /* << High-level action generated for the corresponding key.              >> */ MK_KeyAction_t Action;
